...
import (
	_ "stbchain/x/stablecoin/module"
	stablecoinmoduletypes "stbchain/x/stablecoin/types"
	"time"

	stablecointypes "stbchain/x/stablecoin/types"
...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: stablecointypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner}},
